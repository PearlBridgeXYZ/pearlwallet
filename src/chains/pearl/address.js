 ...
 */
export function bip86Tweak(xOnlyInternal) {
    ...
    const internalPoint = secp256k1.ProjectivePoint.fromHex(Uint8Array.from([0x02, ...xOnlyInternal]));
 ...
 */
export function encodeTaprootAddress(outputKey, params) {
 ...
 */
export function decodeTaprootAddress(address, params) {
...
export function isValidPearlAddress(address, params) {
    try {
...
export function pearlAddressFromInternalKey(xOnlyInternal, params) {
 ...
 */
export function pearlAddressFromCompressedPubkey(compressed, params) {
